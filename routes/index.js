...
router.get('/', function (req, res) {
  res.render('index', { title: 'Instruments App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Instruments App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Instruments App Login', user: req.user });
});
